...
class SistemaDeAsistencia:
    ...
    def create_alumnos_tab(self):
        ...
        self.label_apellidos = tk.Label(self.frame_alumnos, text="Apellido")
        self.label_apellidos.grid(row=1, column=0, padx=10, pady=10)
        self.entry_apellidos = tk.Entry(self.frame_alumnos)
        self.entry_apellidos.grid(row=1, column=1, padx=10, pady=10)
        
        self.label_grados = tk.Label(self.frame_alumnos, text="Grado")
        self.label_grados.grid(row=2, column=0, padx=10, pady=10)
        self.entry_grados = tk.Entry(self.frame_alumnos)
        self.entry_grados.grid(row=2, column=1, padx=10, pady=10)
    ...
    def add_student(self):
        ...
        grados = self.entry_grados.get()
        
        print("Nombre:", nombres)
        print("Apellido:", apellidos)
        print("Grado:", grados)
        
        print("Apellido vacío?", apellidos == "")
        print("Grado vacío?", grados == "")
        
        if nombres and apellidos and grados:
            ...
            c = conn.cursor()
            c.execute("INSERT INTO estudiante (nombres_estudiante, apellido_estudiante, grado) VALUES (%s, %s, %s)", (nombres, apellidos, grados))
            conn.commit()
            conn.close()
